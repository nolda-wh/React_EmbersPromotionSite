    ...
    <div className='bg-white pb-5'>
      ...
      <div className='patchnote'>
        <div className='justify-content-center position-absolute top-50 start-50 translate-middle bg-blur rounded-1 p-4'>
          <div className='font-11 fs-1 text-black text-center px-4 fw-bold'>개발 기록</div>
          <div className='font-11 fs-6 text-black text-center px-4'>세상에 펼치기 위한 여정에 대한 기록</div>
        </div>
